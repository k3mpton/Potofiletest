...
func (x *IsAdmRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdmRequest) ProtoMessage() {}

func (x *IsAdmRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdmRequest.ProtoReflect.Descriptor instead.
func (*IsAdmRequest) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{4}
}

func (x *IsAdmRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *IsAdmResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdmResponse) ProtoMessage() {}

func (x *IsAdmResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdmResponse.ProtoReflect.Descriptor instead.
func (*IsAdmResponse) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{5}
}

func (x *IsAdmResponse) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\fIsAdmRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\")\n" +
	"\rIsAdmResponse\x12\x18\n" +
	"\aIsAdmin\x18\x01 \x01(\bR\aIsAdmin2\xa7\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x122\n" +
	"\aIsAdmin\x12\x12.auth.IsAdmRequest\x1a\x13.auth.IsAdmResponseB\x1eZ\x1cgithub.com/legiseen/sso;k3meb\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*IsAdmRequest)(nil),     // 4: auth.IsAdmRequest
	(*IsAdmResponse)(nil),    // 5: auth.IsAdmResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Auth.IsAdmin:input_type -> auth.IsAdmRequest
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auth.IsAdmin:output_type -> auth.IsAdmResponse
